...
local function run()
  ...
  local character_capture = tmux({ "capture-pane", "-p", "-J", "-t", agent_pane })
  ...
  local line_capture = tmux({ "capture-pane", "-p", "-J", "-t", agent_pane })
  ...
  local block_capture = tmux({ "capture-pane", "-p", "-J", "-t", agent_pane })
